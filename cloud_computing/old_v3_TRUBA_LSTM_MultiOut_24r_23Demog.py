...
class RNNsModelTuning(nn.Module):
    def __init__(self,num_educationCat, num_employmentCat, num_genderCat, num_famTypologyCat,num_numFamMembCat,
                 ...
                 num_CitizenCat,  num_InterOwnCat, num_LandlineCat, num_MobPhoneOwnCat, num_CarOwnCat,
        ...
        self.embedding_dim_Landline = min(embed_size, num_LandlineCat // 2 + 1)
        ...
        self.Landline_embedding = nn.Embedding(num_LandlineCat, self.embedding_dim_Landline)
    ...
    def forward(self,  education_input, employment_input, gender_input, famTypology_input, numFamMemb_input,
                ...
                Citizen_input, InterOwn_input, Landline_input, MobPhoneOwn_input,CarOwn_input,
        ...
        Landline_embedded = self.Landline_embedding(Landline_input).reshape(-1, 24, self.embedding_dim_Landline)
        ...
        concatenated_features = torch.cat((education_embedded,employment_embedded,gender_embedded, famTypology_embedded, numFamMemb_embedded,
                                           ...
                                           Citizen_embedded, InterOwn_embedded, Landline_embedded,
...
def create_dataloader(X, y_activity, y_location,y_withNOB, batch_size, shuffle=False, drop_last=False):
    ...
    season_idx = 23
    weekend_idx = 24
    num_categorical_features = 25 # Update this to the total number of categorical features
    ...
    dataset = TensorDataset(
        ...
        torch.tensor(X[:, :, Landline_idx], dtype=torch.long),
        ...
        for batch_idx, data in enumerate(data_loader):
            try:
                ...
                education_data, employment_data, gender_data, famTypology_data, \
                    ...
                    Citizen_data, InterOwn_data, Landline_data, MobPhoneOwn_data, CarOwn_data, \
                ...
                activity_output, location_output, withNOB_output = model(education_data, employment_data, gender_data,
                                                                         ...
                                                                         OccSeqNumCat_data,
                                                                         Citizen_data, InterOwn_data, Landline_data,
...
def objectiveLSTM_kFold(trial, epochs, df, num_split):
    ...
    num_features = {
        ...
        'num_LandlineCat': df['Landline Ownership'].nunique(),
...
def trainEvaluate_afterTuning(df, csv_filepath, rnn_type='LSTM', epochBase=500,):
    ...
    print(
        ...
        num_features['num_InterOwnCat'], num_features['num_LandlineCat'], num_features['num_MobPhoneOwnCat'],
...
def evaluate_and_save_afterTuning(model, X_test, y_activity_test, y_location_test, y_withNOB_test, label_encoder, device, csv_filepath, arch_type):
    ...
    test_dataset = TensorDataset(
        ...
        torch.tensor(X_test[:, :, Landline_idx], dtype=torch.long),
...
if __name__ == '__main__':
    import pandas as pd
    # INPUT PATHS
    #data = r'dataset_TUS_equalized/tus_main_EqPad1000HHID_RAWDATA_25.csv'
    data = r'dataset_TUS_equalized/tus_main_EqPad100HHID_RAWDATA_25.csv'
