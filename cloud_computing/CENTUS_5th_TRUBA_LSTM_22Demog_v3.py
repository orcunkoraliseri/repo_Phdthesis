...
if __name__ == '__main__':
    ...
    #data = r'dataset_TUS_equalized/tus_main_EqPadHHID_RAWDATA_22.csv'
    ...
    # LSTM:TUNING CROSS-VALIDATION ---------------------------------------------------------------------------
    main_tuningLSTM_kFold(csv_filepath=csv_input, epochs=2, n_trials=2, num_split=3, df=df) # defualt epochs= 20-30, default n_trials= 50-100, default n_split=3-5
