...
def objectiveTransformer_kFold(trial, epochs, df, num_split):
    ...
    d_feed = trial.suggest_categorical('d_feed', [2048, 3072, 4096, 5120, 6144, 7168, 8192])
...
if __name__ == '__main__':
    import pandas as pd
    # INPUT PATHS
    #data = r'dataset_TUS_equalized/tus_mainEqualPadHHID.csv'
    #data = r'dataset_TUS_equalized/tus_main_EqPad100HHID_RAWDATA.csv'
    #data = r'dataset_TUS_equalized/tus_main_EqPad1000HHID_RAWDATA.csv'

    #data = r'dataset_TUS_main/tus_main_RAWDATA_25.csv'
    #data = r'dataset_TUS_equalized/tus_main_EqPadHHID_RAWDATA_25.csv'
    ...
    # LSTM:TUNING CROSS-VALIDATION ---------------------------------------------------------------------------
    main_tuningTransformer_kFold(csv_filepath=csv_input, epochs=3, n_trials=3, num_split=3, df=df) # defualt epochs= 20-30, default n_trials= 50-100, default n_split=3-5
    trainEvaluate_afterTuning(df=df, csv_filepath=csv_input, epochBase=100)